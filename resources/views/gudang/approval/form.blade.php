            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form update status printing : {{ $data->job_ticket }}</h3>
                    ...
                    <div class="box-footer">
                        <a href="/production/public/production/printing" type="submit" class="btn btn-default">Cancel</a>

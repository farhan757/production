  ...
  <div class="modal-body">
    ...
    <div class="row">
      <div class="col-md-12" style="padding-bottom:15">
        <button onclick="printmaterial({{ $data->id }})" class="btn btn-info"><i class="fa fa-print"></i> Material</button>
        <script type="text/javascript">
          function printmaterial($id) {
            window.open('printing/material/'+$id,'print','width=500,height=500');
          }
        </script>
      </div>
    </div>

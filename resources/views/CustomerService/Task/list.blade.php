                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                              ...
                              <td><a href="task/showdetail/{{ $value->id }}" data-toggle="modal" data-target="#modal-{{ $value->id }}">{{ $value->title }}</a></td>
                              <td>{{ $value->name }}</td>
                              <td>{{ $value->create_dt }}</td>
                              <td>{{ $value->username }}</td>
                              <td>{{ $value->priority }}</td>
                              <td><a href="task/update/{{ $value->id }}" class="btn btn-default btn-xs">Update Status</a></td>
                              </td>
                            </tr>
                            @endforeach
                          </table>

				...
				<div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" maxlength="35" id="icon" name="icon" placeholder="Icon" value="{{ $data->icon ?? '' }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer">
                        <a href="/production/public/setting/master/taskstatus" type="submit" class="btn btn-default">Cancel</a>

  ...
  <div class="col-sm-12">
    <div class="card card-outline card-primary">
      <div class="card-header">
        <h3 class="card-title">Data Scan Distribusi</h3>
      </div>
        <div class="card-body">
          ...
          <div class="card-body table-responsive p-0">
            <table  class="table table-bordered table-head-fixed">
              ...
              <tr>
                ...
                <a href="#" title="Scan Distribusi" class="text-danger" onclick="event.preventDefault(); document.getElementById('to-form-scan').submit();"><i class="fas fa-barcode"></i></a>
                    <form id="to-form-scan" action="{{ route('formscan') }}" method="POST" class="d-none">
                      @csrf

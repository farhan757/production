...
class VendorController extends Controller
{
    ...
    public function index() {
    	$list = DB::table('vendor')->orderBy('id','DESC')->paginate(10);
        $view = view('master.vendor.index')->with('list',$list);
    ...
    public function detail($id) {
    	...
    	return view('master.vendor.detail')->with('data',$data);
    }
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            'code'     => 'required|max:10|unique:vendor',

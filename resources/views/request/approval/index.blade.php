  ...
  <div class="col-sm-12">
    <div class="card card-outline card-primary">
      <div class="card-header">
        <h3 class="card-title">List Approval</h3>
      </div>
      <div class="card-body">
          <table class="table table-bordered">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="#" title="show form approval" onclick="showForm({{ $value->id }})" class="text-success"><i class="fas fa-check-circle"></i></a>&nbsp;
                  <a title="download" href="{{ route('downloadapp',$value->id) }}" class="text-success"><i class="fa fa-download"></i></a>
                </td>
              </tr>
              @endforeach
          </table>

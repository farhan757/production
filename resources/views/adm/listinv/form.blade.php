<div class="modal fade" id="modal-form" name="modal-form">
              ...
              <h4 class="modal-title" id="modal-title">Form Upload Approval</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select onchange="status()" class="form-control" name="result_id" id="result_id">
                        ...
                        <div class="form-group row" id="tglbayar-div">
                            <label for="name" class="col-sm-2 control-label">Tgl Dibayar</label>

                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="tglbayar" name="tglbayar" placeholder="Tanggal Dibayar">
                            </div>
                        </div>

                        <div class="form-group row" id="file-div">
